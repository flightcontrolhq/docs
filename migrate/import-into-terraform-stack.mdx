---
title: "Import existing resources into a Terraform Stack"
sidebarTitle: "Import into a Terraform Stack"
description: "Use Terraform import blocks to bring existing resources from any provider under a Ravion rvn-stack module's management through the normal plan and apply pipeline."
---
...
<Prompt description="Add import blocks for existing resources and run them through the Ravion pipeline." icon="sparkles" actions={["copy", "cursor"]}>
  Fetch https://docs.ravion.com/migrate/import-into-terraform-stack.md and follow its manual walkthrough to import my existing resources into the Terraform configuration in this repository, which runs through a Ravion `rvn-stack` module. I will tell you which resources to import. Guardrails:
