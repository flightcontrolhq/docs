...
### 1. "The biggest drift": manual changes and a separate Terraform repo
...
No more hacks to set or override AWS settings that Flightcontrol didn't expose. Essentially every option is now exposed. And if it's not, it's just a simple config change for us to add it. Or you can even fork our standard modules and customize it as you please.
...
We plan to build but don't yet have any migration tooling or prompts. This will follow in the coming weeks.

### Some features still missing as of July 3, 2026
...
### Other migration guides to come
