...
- **Nested module references:** Configure module references inside object maps and arrays. [Module definition schema](https://www.ravion.com/docs/module-definitions/definition-schema/structured-input-types#refinputproperty)
