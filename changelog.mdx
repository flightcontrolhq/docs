...
## Platform
### Features
- **Custom step outputs:** Custom pipeline steps can publish declared string outputs for later steps to use.
...
- Creating a module instance now identifies the selected module and opens its form at the top.
