...
- **OAuth account access:** Existing users signing up with another OAuth provider can reuse their existing account and login flow.
...
- Marketing pages now use consistent grid lines, spacing, and responsive layouts across desktop, tablet, and mobile.
### Fixes
