...
### `ravion deploy instance`

Manage deployment instances

**Aliases:** `instances`

#### `ravion deploy instance get`

Get DeploymentInstance by id

```bash
ravion deploy instance get <id> [flags]
```
...
#### `ravion deploy instance list`

List DeploymentInstances

```bash
ravion deploy instance list [flags]
```
...
### `ravion deploy swap-blue-green`

Swap a blue/green deployment to live traffic

```bash
ravion deploy swap-blue-green [flags]
```
