---
title: "Installation"
description: "Install the Ravion CLI on macOS and Linux."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Configure" icon="sliders" href="/cli/configuration">
    Point the CLI at a different environment with environment variables.
  </Card>
</CardGroup>
