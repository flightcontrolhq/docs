---
title: "CLI overview"
description: "Manage Ravion projects, environments, deployments, and infrastructure from the command line."
---
...
See [Installation](/cli/installation) for version pinning, [Authentication](/cli/authentication) to sign in, and [Configuration](/cli/configuration) for environment variables.
...
<CardGroup cols={2}>
  ...
  <Card title="github" href="/cli/reference/github">
    GitHub integration
  </Card>
  <Card title="gitlab" href="/cli/reference/gitlab">
    GitLab integration
  </Card>
