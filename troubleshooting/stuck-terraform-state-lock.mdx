...
description: "Identify a Terraform state lock left behind by an interrupted run, confirm no operation still holds it, and release it via dashboard, CLI, or API."
