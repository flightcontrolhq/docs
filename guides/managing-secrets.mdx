...
Keep secrets that AWS or a module manages for you — RDS master passwords, ElastiCache connection strings — in their own secrets. That also keeps rotation simple: AWS rotates those secrets in place without touching your environment secret. See [Module-managed secrets](#module-managed-secrets).
