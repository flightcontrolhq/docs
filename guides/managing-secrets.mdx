...
description: "Store application secrets in one AWS Secrets Manager JSON secret per environment, then reference individual keys as runtime variables in your modules."
