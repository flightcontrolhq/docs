    ...
    steps:
      ...
      - name: Apply changes
        ...
        run: |
          ...
          # it: the merged pull request when the subject is a merge or squash
          # commit GitHub authored, otherwise the commit itself. Any other "#123"
          # in a subject is an issue reference, not the pull request that merged.
