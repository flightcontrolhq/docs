...
<Prompt description="Choose and apply the right Ravion deploy guide for this repository." icon="sparkles" actions={["copy", "cursor"]}>
  ...
  2. Use https://www.ravion.com/docs/deploy/aws as the framework-specific source of truth and:
  ...
  6. Leave clear TODOs instead of guessing any AWS account ID, repository slug, project ID, database credential, command, path, or port.
</Prompt>
