...
<Prompt description="Choose and apply the right Ravion deploy guide for this repository." icon="sparkles" actions={["copy", "cursor"]}>
  Use https://www.ravion.com/docs/deploy/aws as the source of truth and:
...
<CardGroup cols={3}>
  ...
  <Card title="Solid" icon="shapes" href="/deploy/aws/solid">
  ...
  <Card title="Vike" icon="code" href="/deploy/aws/vike">
...
<CardGroup cols={3}>
  ...
  <Card title="Bun" icon="bolt" href="/deploy/aws/bun">
  ...
  <Card title="FastAPI" icon="bolt" href="/deploy/aws/fastapi">
  ...
  <Card title="Hono" icon="code" href="/deploy/aws/hono">
