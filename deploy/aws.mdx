...
<Note>
  Each example uses module versions from the current Ravion standard library. Ask the
  user for the repository and AWS account values before applying a file.
</Note>
