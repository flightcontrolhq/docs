...
<AskAssistant question="How do I run Redwood migrations and connect the RDS database secret to the ECS service on Ravion?">
  "How do I run Redwood migrations and connect the RDS database secret to the ECS service on Ravion?"
</AskAssistant>
