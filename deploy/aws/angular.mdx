...
<Prompt description="Set up this Angular app for Ravion static hosting." icon="sparkles" actions={["copy", "cursor"]}>
  ...
  2. Use https://www.ravion.com/docs/deploy/aws/angular as the framework-specific source of truth and:
  ...
  6. Leave a TODO instead of guessing any AWS account ID, repository slug, project ID, or output path.
</Prompt>
