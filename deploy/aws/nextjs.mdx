...
<Prompt description="Set up this Next.js app for Ravion SSR or static hosting." icon="sparkles" actions={["copy", "cursor"]}>
  ...
  2. Use https://www.ravion.com/docs/deploy/aws/nextjs as the framework-specific source of truth and:
  ...
  6. Leave TODOs instead of guessing AWS account IDs, repository slugs, project IDs, output modes, or ports.
</Prompt>
