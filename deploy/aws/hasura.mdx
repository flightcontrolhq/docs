...
<Prompt description="Set up this Hasura app for Ravion ECS hosting." icon="sparkles" actions={["copy", "cursor"]}>
  ...
  2. Use https://www.ravion.com/docs/deploy/aws/hasura as the framework-specific source of truth and:
  ...
  6. Leave TODOs instead of guessing AWS account IDs, image or repository values, project IDs, or database credentials.
</Prompt>
