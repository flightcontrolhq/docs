...
<Prompt description="Set up this Astro app for Ravion static or SSR hosting." icon="sparkles" actions={["copy", "cursor"]}>
  ...
  2. Use https://www.ravion.com/docs/deploy/aws/astro as the framework-specific source of truth and:
  ...
  6. Leave TODOs instead of guessing missing AWS account IDs, repository slugs, database credentials, or adapter output.
</Prompt>
