...
<Prompt description="Set up this Laravel app for Ravion ECS hosting." icon="sparkles" actions={["copy", "cursor"]}>
  ...
  2. Use https://www.ravion.com/docs/deploy/aws/laravel as the framework-specific source of truth and:
  ...
  7. Leave clear TODOs instead of guessing the PHP version, app root, AWS account ID, repository slug, project ID, or database credentials.
</Prompt>
