...
<Prompt description="Set up this Vike app for Ravion static hosting." icon="sparkles" actions={["copy", "cursor"]}>
  ...
  2. Use https://www.ravion.com/docs/deploy/aws/vike as the framework-specific source of truth and:
  ...
  6. Leave TODOs instead of guessing missing AWS account IDs, repository slugs, project IDs, or adapter output.
</Prompt>
